...
class TestAggregationAbsolute(TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.runModule("t.register", flags="i", type="raster", input="A",
                      maps="a1,a2,a3", start="2001-01-01", increment="2 days", overwrite=True)
    ...
    def test_fabs_function(self):
        ...
        udf_file = open("/tmp/udf_fabs.py", "w")
        code = """
def hyper_fabs(udf_data: UdfData):
    ...
    return udf_data
        ...
        self.assertModule("t.rast.udf", inputs="A", output="B", basename="fabs_a", pyfile="/tmp/udf_fabs.py",
                          overwrite=True, nrows=3)

        self.assertModule("t.info", type="strds", input="B")
        self.assertModule("t.rast.list", input="B")
        self.assertRasterMinMax(map="fabs_a_1", refmin=100, refmax=300, msg="Minimum must be 100")
